...
class createUI():
    ...
    def createWindow(self):
        ...
        nBut01 = mc.button(l='0. Set Rig Names',c=self.handler02)
        mc.setParent('..')
        ...
        #1
        mc.columnLayout()
        but01 = mc.button(l='1. Build Ctls',c=self.buildRig01,w=250,h=30)
        but03 = mc.button(l='2. Connect Ctls',c=self.buildRig02,w=250,h=30)
        but05 = mc.button(l='3. Bind Geo',c=self.buildRig03,w=250,h=30)
        mc.setParent('..')
        ...
        hBut02 = mc.button(l='Normalize ctl',w=230)
        ...
        mc.frameLayout( l='Danger Zone', collapsable=True, collapse=True, mw=10, mh=5)
        #3
        mc.button(l='Delete Rig',w=300,bgc=red)
